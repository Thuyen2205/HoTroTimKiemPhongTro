...
const DangKy = () => {
    ...
    return <>
        ...
        {err === null ? "" : <center><Alert style={{width:'50%', marginTop:'15px'}} variant="danger">{err}</Alert></center>}
        <div className="formDangKy">
        <h2 className="text-center text-info mt-2">ĐĂNG KÝ TÀI KHOẢN</h2>
            <Form onSubmit={register}>
                ...
                <Form.Group className="mb-3">
                    {loading === true ? <MySpinner /> : <center><Button style={{width:'60%', fontSize:'17px'}}  variant="info" type="submit">Đăng ký</Button></center>}
